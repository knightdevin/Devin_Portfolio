  ...
  return (
    <div id="contact_container" className="pageContent">
      ...
      <div className="expAndEduBox">
        ...
        <ul className="responsibilities">
          <li className="bullet">
            The M.S. in Public Relations and Corporate Communications program is
            a 42-credit program focused on written communication and
            presentation skills, ethics, law, social media strategies, research
            methodologies, and regulatory practices.
          </li>
          <li className="bullet">
          ...
          <li>
            ...
            Professional Studies Student Rep. during informational sessions for
      ...
      <div className="expAndEduBox">
        ...
        <ul className="responsibilities">
          ...
          <li>
            Activities: Media Mentor: Met with young journalism students weekly
            at Reseda High School in Reseda, CA, to teach basic journalism
            principles. Developed class workshops and lectures evaluated
            students' writing to prepare for publication for their high school
            paper.
          </li>
        </ul>
      </div>
